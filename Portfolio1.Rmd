...
Aside from this, the data is very interesting. There are tons of other variables I would like to explore this in data set, but the bulk of my time on this was taken up my merging the data sets. Either ways, portfolio has been very fun. 
